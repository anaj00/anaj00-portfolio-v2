export default [
    {
    tag: 'Data Science / AI',
      title: 'Corallian: Coral Segmentation and Classification using Deep Learning (Undergraduate Thesis)',
      description: 'Developing a deep learning pipeline to segment and classify coral species from underwater imagery.',
    ...
    },
    {
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/Dwigoric/stdiscm-probset-4', icon: 'mdi-github' },
      ]
    },
    {
        tag: 'Software Development',
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/anaj00/MOBDEVE-FurMate', icon: 'mdi-github' },
      ]
    },
     {
    tag: 'UI/UX Design',
    ...
    links: [
        { title: 'Prototype', href: 'https://www.figma.com/proto/jx34qnkg7o9K0p7TGez66a/-STHCIUX--App-Prototype?page-id=0%3A1&node-id=1-179&node-type=canvas&viewport=-364%2C-1751%2C0.37&t=SwIkJhrZWNopUxF8-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=1%3A179', icon: 'mdi-open-in-new' }
    ]
    },
    {
        tag: 'Software Development',
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/anaj00/CSOPESY-MCO-OS-Emulator', icon: 'mdi-github' }
      ]
    },
    {
        tag: 'Software Development',
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/svcheng/CSARCH2-Simulation-Project', icon: 'mdi-github' },
    ...
    },
    {
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/Ethea2/petter-care', icon: 'mdi-github' }
      ]
    },
    {
        tag: 'Software Development',
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/Dwigoric/unboundmnl-area-2', icon: 'mdi-github' }
      ]
    },
    {
        tag: 'Software Development',
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/anaj00/CCAPDEV-Tastee', icon: 'mdi-github' },
    ...
    `,
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/anaj00/STADVDB-MC02-WebApp', icon: 'mdi-github' }
      ]
    },
    {
        tag: 'Software Development',
    ...
    `,
      ...
      links: [
        { title: 'GitHub Repo', href: 'https://github.com/anaj00/CCPROG3-myFarm', icon: 'mdi-github' }
      ]
    },
